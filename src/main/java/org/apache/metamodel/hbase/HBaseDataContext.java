...
public class HBaseDataContext extends QueryPostprocessDataContext {
    ...
    /**
     * Creates a {@link org.apache.metamodel.hbase.HBaseDataContext}.
     * 
     * @param configuration
     */
    ...
    /**
     * Gets the HBaseAdmin used by this {@link org.apache.metamodel.DataContext}
     * 
     * @return
     */
    ...
    /**
     * Gets the {@link org.apache.metamodel.hbase.HBaseConfiguration} that is used in this datacontext.
     * 
     * @return
     */
    ...
    protected Number executeCountQuery(Table table, List<FilterItem> whereItems, boolean functionApproximationAllowed) {
        ...
        try {Scan scan =new Scan();
            scan.setFilter(new PrefixFilter(getRowkeyPrefix().getBytes()));
